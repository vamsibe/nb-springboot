 ...
 */
public class SimpleCharStream2 {

    private LexerInput input;

    static boolean staticFlag;

    public SimpleCharStream2(LexerInput input) {
        this.input = input;
    }

    SimpleCharStream2(Reader stream, int i, int i0) {
        throw new UnsupportedOperationException("Not yet implemented");
    }

    SimpleCharStream2(InputStream stream, String encoding, int i, int i0) throws UnsupportedEncodingException {
        throw new UnsupportedOperationException("Not yet implemented");
    }
